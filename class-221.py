...
try:
    ...
    police_car_spawn_point = world.get_map().get_spawn_points()[5]
    ...
    def _Radar_callback(radar_data):
        ...
        for detection in radar_data:
            ...
            if distanceNameData["distance"] > 3 and distanceNameData["distance"] < 6:
                ...
                dropped_vehicle.apply_control(
                    carla.VehicleControl(throttle=0.25, steer=-0.2)
                )
                time.sleep(1)
                dropped_vehicle.apply_control(
                ...
                time.sleep(1)
                if distanceNameData["distance"] > 5:
                    car_control()
            else:
                continue
    ...
    actor_list.append(cybertruck_car)
