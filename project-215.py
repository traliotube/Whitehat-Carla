...
def semantic_lidar_data(point_cloud, lidar_point_cloud_buffer):
    ...
    matrix_representational_data = np.frombuffer(
    ...
    lidar_points = np.array(
        [
            matrix_representational_data["x"],
            -matrix_representational_data["y"],
            matrix_representational_data["z"],
        ]
    ).T
...
try:
    ...
    visualise_lidar_using_mayavi = mlab.points3d(
        10, 10, 10, 10, mode="point", figure=lidar_figure, colormap="gnuplot"
    )
