...
class KeyboardControl(object):
    ...
    def _parse_vehicle_keys(self, keys, milliseconds):
        ...
        if keys[K_UP] or keys[K_w]:
            self._control.throttle = min(self._control.throttle + 0.0001, 1)
        else:
        ...
        with open("manual_control_data.txt", "w") as f:
            f.write(json.dumps(store_driving_data))

        with open("manual_control_data.txt", "r") as f:
