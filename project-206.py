...
try:
    ...
    def speed(speed): return carla.VehicleControl(throttle=speed)
    def brake(brake): return carla.VehicleControl(hand_brake=brake)
    def steer1(steering): return carla.VehicleControl(steer=steering)

    dropped_vehicle.apply_control(brake(False))
    dropped_vehicle.apply_control(speed(0.5))
    time.sleep(3)
    dropped_vehicle.apply_control(brake(True))
    time.sleep(10)
    dropped_vehicle.apply_control(brake(False))
    dropped_vehicle.apply_control(speed(0.5))
    time.sleep(5)
    dropped_vehicle.apply_control(steer1(-0.65))
    dropped_vehicle.apply_control(speed(0.5))
    time.sleep(5)
    dropped_vehicle.apply_control(steer1(-0.65))
    time.sleep(12)
