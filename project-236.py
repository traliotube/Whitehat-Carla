...
def generate_lidar_blueprint(blueprint_library):
    lidarBlueprint = blueprint_library.filter("sensor.lidar.ray_cast_semantic")[0]
    lidarBlueprint.set_attribute("channels", str(64))
    lidarBlueprint.set_attribute("rotation_frequency", str(40))
    lidarBlueprint.set_attribute("points_per_second", str(56000))
    lidarBlueprint.set_attribute("range", str(100))
    return lidarBlueprint
...
try:
    ...
    mustang_car_spawn_point = world.get_map().get_spawn_points()[
        4
