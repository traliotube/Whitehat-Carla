...
# write code here for semantic data function to calculate distance and display name of the object
def semantic_data(point_cloud_data):
    distance_name_data = {}
    for detection in point_cloud_data:
        ...
        print("Distance and name data of surrounding: ", distance_name_data)
...
try:
    ...
    sensor.listen(lambda data: semantic_data(data))
